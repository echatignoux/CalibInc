---
title: "How to produce sound predictions of incidence at a district level using either healthcare or mortality data in the absence of a national registry: the example of cancer in France"
...
The `tidyverse`, `magrittr`, `mgcv`, `spdep` and `INLA` packages are also needed to run the
following code.
